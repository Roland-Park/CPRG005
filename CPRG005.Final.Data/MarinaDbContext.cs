    ...
    public class MarinaDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LeaseType>().HasData(
                ...
                new LeaseType() { Id = 2, Name = "Weekly", StandardRateAmount = 80.00m },
                new LeaseType() { Id = 3, Name = "Monthly", StandardRateAmount = 200.00m },
                new LeaseType() { Id = 4, Name = "Yearly", StandardRateAmount = 2000.00m }
                );
